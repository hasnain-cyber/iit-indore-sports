        ...
        <div id={'home-footer-return-wrapper'}>
            <div id={'home-footer-upper-wrapper'}>
                ...
                <div className={'home-footer-image-wrapper'}>
                    ...
                    <a href="https://www.instagram.com/iitisports" target="_blank" rel="noreferrer">
                        <svg width="24" height="24" id='instagram-icon'>
                            <path fill="#837D88"
                    ...
                    <a href='https://twitter.com/iitisports' target="_blank" rel="noreferrer">
                        <svg width="24" height="20" id='twitter-icon'>
                            <path fill="#837D88"
            ...
            <div id="home-footer-extras-wrapper">
                ...
                <div>
                    ...
                    <div className={'home-footer-image-wrapper'} style={{margin: "0 auto"}}>
                        ...
                        <a id={'footer-call-icon'} href={'void(0)'} target="_blank"
                           rel="noreferrer">
                            <Call/>
                        </a>
                    </div>
